...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/accessnode: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/accessnode ${OBJECTFILES} ${LDLIBSOPTIONS} `libgcrypt-config --libs`

${OBJECTDIR}/_ext/1270477542/assert.o: ../common/assert.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1270477542
	${RM} $@.d
	$(COMPILE.c) -O2 `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/assert.o ../common/assert.c

${OBJECTDIR}/_ext/1270477542/cutils.o: ../common/cutils.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1270477542
	${RM} $@.d
	$(COMPILE.c) -O2 `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/cutils.o ../common/cutils.c

${OBJECTDIR}/_ext/1270477542/helpers.o: ../common/helpers.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1270477542
	${RM} $@.d
	$(COMPILE.c) -O2 `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/helpers.o ../common/helpers.c
