...
${OBJECTDIR}/_ext/1270477542/assert.o: ../common/assert.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Wall -D_DEBUG `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/assert.o ../common/assert.c

${OBJECTDIR}/_ext/1270477542/cutils.o: ../common/cutils.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1270477542
	${RM} $@.d
	$(COMPILE.c) -g -Wall -D_DEBUG `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/cutils.o ../common/cutils.c

${OBJECTDIR}/_ext/1270477542/helpers.o: ../common/helpers.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1270477542
	${RM} $@.d
	$(COMPILE.c) -g -Wall -D_DEBUG `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1270477542/helpers.o ../common/helpers.c
...
${OBJECTDIR}/smain.o: smain.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Wall -D_DEBUG `libgcrypt-config --cflags` -MMD -MP -MF $@.d -o ${OBJECTDIR}/smain.o smain.c
